# streamlit  web Application for Pharma drugs Predication - Digvijay Patil
...
# Create a Header
st.set_page_config(page_title='Pharma Drugs - Digvijay')

# Add a little to application in body
st.title("Pharma Drugs prediction - Digvijay Patil")
